...
class ScreenController:
    ...
    async def capture_async(self, path: Optional[str] = None) -> str:
        return await asyncio.to_thread(self.capture, path)
